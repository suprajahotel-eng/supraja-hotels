...
export const metadata: Metadata = {
  title: "Hotels in Hyderabad | Supraja Hotels Direct Booking",
  description:
    "Hotels in Hyderabad by Supraja Hotels offer comfortable rooms, prime locations, direct booking support and trusted hospitality across Madhapur and Chandanagar.",
  keywords: [
    "Hotels in Hyderabad",
  ...
  openGraph: {
    ...
    description:
      "Explore Supraja Hotels in Hyderabad for comfortable stays, prime locations and direct booking support.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
...
const hotelDescriptions: Record<string, string> = {
  "supraja-cyber-view":
    "A comfortable hotel in Madhapur with easy access to Hitech City, Cyber Towers and major business areas.",
  "supraja-residency":
    "A trusted hotel in Chandanagar for families, professionals and guests looking for convenient access.",
  "supraja-lodge":
    ...
    <>
        ...
        <div className="container-custom grid items-center gap-12 lg:grid-cols-[52%_48%]">
          <div>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
              Hotels in Hyderabad by Supraja Hotels are designed for guests who
              need clean rooms, prime locations, direct hotel booking support
              and dependable hospitality across Madhapur and Chandanagar.
            </p>
        ...
        <div className="container-custom">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 leading-8 text-slate-600">
              ...
              Chandanagar. Whether you are searching for hotel booking in
              Hyderabad, budget hotels in Hyderabad, business hotels in
              Hyderabad, family hotels in Hyderabad or hotels near Hitech City,
              Supraja Hotels gives you practical comfort with direct support.
            </p>
          </div>
              ...
              >
                <div className="relative h-64 bg-slate-100 lg:h-full">
                  <Image
                    ...
                    alt={`${hotel.name} hotel in Hyderabad`}
                    fill
                    className="object-cover"
      ...
      <section className="bg-slate-50 px-4 py-20">
        <div className="container-custom grid gap-12 lg:grid-cols-[38%_62%]">
          <div>
            ...
            <p className="mt-5 leading-8 text-slate-600">
              Supraja Hotels focuses on practical hospitality. Guests choose us
              because our properties are accessible, comfortable and supported
              by direct booking assistance through phone and WhatsApp.
            </p>
          </div>
      ...
      <section className="bg-white px-4 py-20">
        <div className="container-custom">
          <div className="grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-5 leading-8 text-slate-600">
                ...
                the best property based on travel purpose. Supraja Hotels keeps
                the booking process simple for guests visiting Hyderabad for
                business, family visits, medical needs and short city stays.
              </p>
            ...
            <div>
              ...
              <p className="mt-5 leading-8 text-slate-600">
                If you are comparing accommodation options, Supraja Hotels gives
                you a balanced choice between comfort, location and booking
                convenience.
              </p>
            </div>
          </div>
          ...
          <p className="mt-10 leading-8 text-slate-600">
            For guests searching for reliable Hotels in Hyderabad, Supraja
            Hotels offers comfortable rooms, practical amenities, convenient
            locations and direct booking support across Madhapur and
            Chandanagar.
          </p>
        </div>
      </section>
      ...
      <section className="bg-slate-950 px-4 py-16 text-white">
        <div className="container-custom flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
          <div>
            <h2 className="text-3xl font-semibold">Book Direct and Stay Better</h2>
